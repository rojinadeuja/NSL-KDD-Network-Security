...
\section{Dataset}
For the purpose of this experiment, we use the NSL-KDD dataset. NSL-KDD dataset was released as a new and improved version of KDD'99 dataset by the University of New Brunswick. It is used as a benchmark data to evaluate various intrusion detection methods on modern-day network systems.
